...
Source: Young and Onoda (\hyperref[0]{2017})
...
Remote sensing has a wide range of applications in environmental
monitoring, agriculture, disaster management, urban planning, and
security.

In environmental studies, satellite imagery helps track deforestation,
land use changes, and air and water pollution. High spatial resolution
images from satellites like Sentinel-2 and Landsat monitor illegal
logging (\href{https://doi.org/10.3390/rs11080961}{lima and
Beuchle,2019}) and urban expansion ((Frimpong and Molkenthin 2021)) .
Spectral resolution data, particularly near-infrared, assesses
vegetation health and carbon storage, while satellites like MODIS and
Sentinel-5P detect pollutants in the atmosphere and water bodies.
