...
Source：Z. Liu, Chen, and Chen (2023)
...
\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-3649435062.png}}

Figure 1 Closer look of ALOS/PALSAR images of the target study site
acquired before and after

Source: Park, Yamaguchi, and Kim (2013)

For marine oil spill detection, SAR provides real-time and continuous
monitoring of oil pollution. Deep learning models, such as
Transformer-UNet and multi-model learning approaches, improve detection
accuracy, even in low-quality SAR images. The integration of denoising
techniques, such as FFDNet with TransUNet, further refines spill
identification. These advancements contribute to more robust and
scalable SAR-based oil spill monitoring systems(Dong et al. 2023).

\pandocbounded{\includegraphics[keepaspectratio]{images/clipboard-2324078235.png}}
...
\bibitem[\citeproctext]{ref-dong2023}
...
\bibitem[\citeproctext]{ref-liu2016geological}
...
\bibitem[\citeproctext]{ref-park2013}
...
\bibitem[\citeproctext]{ref-yuan2022research}
